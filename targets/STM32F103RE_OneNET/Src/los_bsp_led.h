...
#define macLED1_GPIO_PIN		  GPIO_Pin_4			          /* LED引脚号 */
...
#define macLED3_GPIO_PIN		  GPIO_Pin_6			          /* LED引脚号 */

#define macLED4_GPIO_PORT    	GPIOA			              /* GPIO端口 */
#define macLED4_GPIO_CLK 	    RCC_APB2Periph_GPIOA		/* GPIO端口时钟 */
#define macLED4_GPIO_PIN		  GPIO_Pin_7			          /* LED引脚号 */

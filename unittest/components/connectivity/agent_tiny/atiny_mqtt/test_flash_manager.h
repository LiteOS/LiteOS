...
#ifndef __TEST_FLASH_MANAGER_H__
#define __TEST_FLASH_MANAGER_H__
...
/* Extern variables ---------------------------------------------------------*/
/* Functions API ------------------------------------------------------------*/
class TestFlashmanager : public Test::Suite
{
public:
    TestFlashmanager();
    ~TestFlashmanager();

	void test_flash_manager_init(void);
	void test_flash_manager_read(void);
	void test_flash_manager_write(void);
...
#endif /* __TEST_FLASH_MANAGER_H__ */

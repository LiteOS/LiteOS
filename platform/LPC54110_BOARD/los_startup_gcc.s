...
/* start address for the initialization values of the .ramx section. 
defined in linker script */
.word  _siramx
/* start address for the .ramx section. defined in linker script */  
.word  _sramx
/* end address for the .ramx section. defined in linker script */
.word  _eramx
...
/* Copy the ramx segment initializers from flash to SRAM */  
  movs  r1, #0				/*将0放入到r1寄存器中*/
  b  LoopCopyRamInit		/*强制跳转到LoopCopyRamInit标签处*/
  
CopyRamxInit:				/*实现flash中的_siramx++4、8、12....的值依次拷贝到RAM中的_sdata++4、8、12....的地方，主要就是data段数据拷贝*/
  ldr  r3, =_siramx			/*将_sidata的地址放入到r3中*/
  ldr  r3, [r3, r1]			/*将存储器地址为R3+R1的字数据读入寄存器R3*/
  str  r3, [r0, r1]			/*将R3中的值存到以R0+R1的值为地址的内存处*/
  adds  r1, r1, #4			/*将r1加4的地址放入到r1中*/
 
LoopCopyRamInit: 
  ldr  r0, =_sramx			/*将_sramx的地址放入到r0中*/
  ldr  r3, =_eramx			/*将_eramx的地址放入到r3中*/
  adds  r2, r0, r1			/*将r0与r1的地址相加放入到r2中*/
  cmp  r2, r3				/*比较r2和r3是否相等*/
  bcc  CopyRamxInit			/*如果不相等就跳转到CopyRamxInit标签处*/

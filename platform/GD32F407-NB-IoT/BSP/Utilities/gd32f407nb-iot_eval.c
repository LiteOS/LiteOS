...
static uint32_t KEY_PORT[KEYn] = {USER1_KEY_GPIO_PORT, USER2_KEY_GPIO_PORT}; 
                                  
static uint32_t KEY_PIN[KEYn] = {USER1_KEY_PIN, USER2_KEY_PIN};

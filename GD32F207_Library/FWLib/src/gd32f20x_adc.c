...
/* ADC ADC_OVSCR mask */
#define ADC_OVSCR_RESOLUTION_CLEAR      ((uint32_t)0xFFFFCFFF)
#define ADC_OVERSAMPLER_SHIFT_CLEAR     ((uint32_t)0xFFFFFE1F)
#define ADC_OVERSAMPLER_RATIO_CLEAR     ((uint32_t)0xFFFFFFE3)
#define TRIGGERED_OVERSAMPLING_SET      ((uint32_t)0x00000200)
#define OVERSAMPLING_SET                ((uint32_t)0x00000001)
...
void ADC_Resolution_Config(ADC_TypeDef* ADCx, uint32_t ADC_Resolution)
{
    ...
    /* Get OVSCR value */
    temp1 = ADCx->OVSCR;
    temp1 = temp1&ADC_OVSCR_RESOLUTION_CLEAR;
    temp2 = ADC_Resolution;
    temp1 |= temp2;
    ADCx->OVSCR = temp1;
}
...
void ADC_OversamplingShift_Config(ADC_TypeDef* ADCx, uint32_t ADC_Oversampling_Shift)
{
    ...
    /* Get OVSCR value */
    temp1 = ADCx->OVSCR;
    temp1 = temp1&ADC_OVERSAMPLER_SHIFT_CLEAR;
    temp2 = ADC_Oversampling_Shift;
    temp1 |= temp2;
    ADCx->OVSCR = temp1;
}
...
void ADC_OversamplingRatio_Config(ADC_TypeDef* ADCx, uint32_t ADC_Oversampling_Ratio)
{
    ...
    /* Get OVSCR value */
    temp1 = ADCx->OVSCR;
    temp1 = temp1&ADC_OVERSAMPLER_RATIO_CLEAR;
    temp2 = ADC_Oversampling_Ratio;
    temp1 |= temp2;
    ADCx->OVSCR = temp1;
}
...
void ADC_TriggeredOversampling_Enable(TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        ...
        ADC1->OVSCR |= TRIGGERED_OVERSAMPLING_SET;
    }
    else
    {

...
/**
  * @brief  Enable or disable the SPI1_IO34 Output.
  * @param  NewValue: ENABLE or DISABLE.
  * @retval None
  */
void QSPI_IO34DRV(TypeState NewValue)
{
    if (NewValue != DISABLE)
    {
        SPI1->SPIQWCR |= SPI_QWCR_IO34_DRV;
    }
    else
    {
        SPI1->SPIQWCR &=~SPI_QWCR_IO34_DRV;  
...
/**
  ...
  * @retval None
  */
void QSPI_Enable(TypeState NewValue)
{
    if (NewValue != DISABLE)
    { 
        SPI1->SPIQWCR |= SPI_QWCR_QMOD;
    }
    else
    {
        SPI1->SPIQWCR &=~SPI_QWCR_QMOD;     
...
/**
  ...
  * @retval None
  */
void QSPI_Read_Enable( TypeState NewValue)
{
    if (NewValue != DISABLE)
    {    
        SPI1->SPIQWCR |=SPI_QWCR_QRD;
    }
    else
    {
        SPI1->SPIQWCR &=~SPI_QWCR_QRD;        
...
/**
  ...
  * @retval None
  */
void QSPI_Write_Enable( TypeState NewValue)
{
    if (NewValue != DISABLE)
    {    
        SPI1->SPIQWCR &=~SPI_QWCR_QRD; 
